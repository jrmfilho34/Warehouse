...
<section class="content">
      <div class="row">
		...
		@endif
            ...
            <!-- /.box-header -->
            <div class="box-body">
             <form method="POST" action="{{ route('baixar') }}" >
			    {{ csrf_field() }}
			        ...
			        <div class="row">
						...
						<div class="col-xs-6">
						  <div class="form-group">
						    ...
						    <input name="quantidadeS" value="{{ old('quantidadeS') }}" type="number" class="form-control" id="exampleInputPassword1" placeholder="Quantidade">
						  </div>
				        </div>
				    </div>
				  <div class="form-group">
				    <label for="exampleInputPassword1">Destino</label>
				    <input name="destino" value="{{ old('destino') }}" type="text" class="form-control" id="exampleInputPassword1" step="0.01" placeholder="valor">
				  </div>
